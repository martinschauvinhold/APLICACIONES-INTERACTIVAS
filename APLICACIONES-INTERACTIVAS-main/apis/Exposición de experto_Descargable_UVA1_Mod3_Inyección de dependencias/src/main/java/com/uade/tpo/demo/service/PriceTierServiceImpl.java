...
public class PriceTierServiceImpl implements PriceTierService {
    ...
    /**
     * Devuelve el precio aplicable para una variante segun la cantidad.
     * Busca el tier con mayor minQuantity que sea <= quantity.
     * Si no hay tiers configurados, devuelve el basePrice de la variante.
     */
