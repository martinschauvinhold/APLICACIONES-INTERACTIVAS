...
public class DiscountsController {
    ...
    @GetMapping
    public ResponseEntity<ArrayList<Discount>> getDiscounts() {
    ...
    @PostMapping
    public ResponseEntity<Object> createDiscount(@RequestBody DiscountRequest discountRequest) {
        Discount result = discountService.createDiscount(discountRequest);
    ...
    public ResponseEntity<Object> updateDiscount(@PathVariable int discountId,
        ...
        Optional<Discount> result = discountService.getDiscountById(discountId);
        if (result.isPresent()) {
            Discount updated = discountService.updateDiscount(discountId, discountRequest);
